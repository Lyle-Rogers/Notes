...
def choice3():
    ...
    if choice == "call one one over":
        ...
        print(
            "When you head back into the cell, you notice that the stones on the wall aren't exactly solid, but from what you can tell, taking them all out won't let you escape. Instead, it seems like they were jammed in certain ways to make it look like they wall was completely normal."
        )
        print("Press enter to continue...")
        input()
...
def choice4():
    ...
    if choice == "pull on the stones":
        print(
            "once You pry a few of the stones loose, you hide them under your haystack, in case one of the orcs turns to look into your cell. Behind one of the stones, you find a thin, folded piece of paper. While it's not in the best condition, it's still legible. There are other stones to pull still."
        )
        print("Press enter to contnue...")
        input()
        print(
